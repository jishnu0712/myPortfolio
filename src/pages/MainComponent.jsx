...
const MainComponent = () => {
  ...
  const classNames = {
    container: `flex-grow p-8 w-full flex flex-col justify-center items-center sm:flex-col lg:flex-row ${
      darkMode ? theme["dark"] : ""
    }`,
    intro: `intro m-16 select-none ${
      darkMode ? "text-white" : "text-gray-900"
    }`,
    headline: `headline font-bold text-4xl tracking-widest hover:text-indigo-400 ${
      darkMode ? "text-white" : "text-gray-900"
    }`,
    ...
    subHeadline: `sub-headline font-bold text-xl tracking-wider text-left hover:text-indigo-700 ${
      darkMode ? "text-gray-300" : "text-gray-700"
    }`,
    listItem: `coffee hover:text-indigo-700 hover:font-bold ${
  ...
  return (
    <main className={classNames.container}>
      <img
        src={process.env.PUBLIC_URL + "/img/myImg.jpeg"}
        alt="profile cover"
        className="img-circle w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 rounded-full bg-blue-300 shadow-xl border-8 border-gray-200"
      />
